...
// compare_documents_cpp
Eigen::SparseMatrix<double> compare_documents_cpp(Eigen::SparseMatrix<double>& m, std::vector<int> group, std::vector<int> order, int lwindow, int rwindow, std::string measure, double min_value, bool verbose);
RcppExport SEXP _corpustools_compare_documents_cpp(SEXP mSEXP, SEXP groupSEXP, SEXP orderSEXP, SEXP lwindowSEXP, SEXP rwindowSEXP, SEXP measureSEXP, SEXP min_valueSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::SparseMatrix<double>& >::type m(mSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type group(groupSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(compare_documents_cpp(m, group, order, lwindow, rwindow, measure, min_value, verbose));
    return rcpp_result_gen;
END_RCPP
}
// compare_documents_xy_cpp
Eigen::SparseMatrix<double> compare_documents_xy_cpp(Eigen::SparseMatrix<double>& m_x, std::vector<int> group_x, std::vector<int> order_x, Eigen::SparseMatrix<double>& m_y, std::vector<int> group_y, std::vector<int> order_y, int lwindow, int rwindow, std::string measure, double min_value, bool verbose);
RcppExport SEXP _corpustools_compare_documents_xy_cpp(SEXP m_xSEXP, SEXP group_xSEXP, SEXP order_xSEXP, SEXP m_ySEXP, SEXP group_ySEXP, SEXP order_ySEXP, SEXP lwindowSEXP, SEXP rwindowSEXP, SEXP measureSEXP, SEXP min_valueSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::SparseMatrix<double>& >::type m_x(m_xSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type group_x(group_xSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type order_x(order_xSEXP);
    Rcpp::traits::input_parameter< Eigen::SparseMatrix<double>& >::type m_y(m_ySEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type group_y(group_ySEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type order_y(order_ySEXP);
    Rcpp::traits::input_parameter< int >::type lwindow(lwindowSEXP);
    Rcpp::traits::input_parameter< int >::type rwindow(rwindowSEXP);
    Rcpp::traits::input_parameter< std::string >::type measure(measureSEXP);
    Rcpp::traits::input_parameter< double >::type min_value(min_valueSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(compare_documents_xy_cpp(m_x, group_x, order_x, m_y, group_y, order_y, lwindow, rwindow, measure, min_value, verbose));
    return rcpp_result_gen;
END_RCPP
}
// fast_factor_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_corpustools_compare_documents_cpp", (DL_FUNC) &_corpustools_compare_documents_cpp, 8},
    {"_corpustools_compare_documents_xy_cpp", (DL_FUNC) &_corpustools_compare_documents_xy_cpp, 11},
