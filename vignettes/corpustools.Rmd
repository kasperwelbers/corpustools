...
The output of this function is the same as `search_features`, so we can do anything with it as discussed above. For example, we can aggregate and plot the data.
