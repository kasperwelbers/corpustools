...
The first time a query search is performed the token column is indexed to enable fast binary search. More generally, a query can be performed using any character/factor type column in tc$tokens, but indexing of columns only happens after it has been queried the first time. 
